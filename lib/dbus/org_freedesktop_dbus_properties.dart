...
class OrgFreedesktopDBusPropertiesPropertiesChanged extends DBusSignal {
  ...
  OrgFreedesktopDBusPropertiesPropertiesChanged(DBusSignal signal) : super(sender: signal.sender, path: signal.path, interface: signal.interface, name: signal.name, values: signal.values);
}
...
class OrgFreedesktopDBusProperties extends DBusRemoteObject {
  ...
  late final Stream<OrgFreedesktopDBusPropertiesPropertiesChanged> propertiesChanged;

  OrgFreedesktopDBusProperties(DBusClient client, String destination, DBusObjectPath path) : super(client, name: destination, path: path) {
    propertiesChanged = DBusRemoteObjectSignalStream(object: this, interface: 'org.freedesktop.DBus.Properties', name: 'PropertiesChanged', signature: DBusSignature('sa{sv}as')).asBroadcastStream().map((signal) => OrgFreedesktopDBusPropertiesPropertiesChanged(signal));
  }
